    ...
    public partial class initial1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 9, 16, 11, 22, 43, 139, DateTimeKind.Local).AddTicks(706), "Kalem1", 100m, 20, null },
                    { 2, 2, new DateTime(2023, 9, 16, 11, 22, 43, 139, DateTimeKind.Local).AddTicks(720), "Kitap1", 300m, 10, null }
                });

            migrationBuilder.InsertData(
                table: "ProductFeatures",
                columns: new[] { "Id", "Colour", "Height", "ProductId", "Widht" },
                values: new object[,]
                {
                    { 1, "Kırmızı", 100, 1, 200 },
                    { 2, "Mavi", 100, 2, 200 }
